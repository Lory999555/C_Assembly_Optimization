...
//extern void colDistance32Block(float * ds,float* c,float* distance,int i,int j,int d,int n,int b);	//test sul cache-blocking
...
/*metodo che calcola il centroide più vicino al parametro x. Variante Aligned*/
...
/*metodo che calcola il centroide più vicino al parametro x. Variante Unaligned*/
